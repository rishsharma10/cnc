...
const ContentPage = () => {
  ...
  console.log(router.query,"typeofcontent")
                ...
                <Row justify={"center"}>
                  <Col span={24}>
                    <Flex justify="space-between" align="middle" className="mb-3">
                      <TypographyTitle level={4} className="mb-0">{router?.query?.type === "security-and-privacy" ? 'Security & Privacy' : "Terms & Conditions"}</TypographyTitle>
