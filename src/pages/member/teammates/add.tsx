                    ...
                    <Row>
                        <Col span={24} md={20} lg={18} xl={14} xxl={12}>
                            ...
                            <AntForm size="large" layout="vertical" onFinish={addTeamMates}>
                                ...
                                {/* Department */}
                                {/* <FormItem className="mb-4" label={<TypographyText className="fs-16">Department</TypographyText>}>
                                    <Space direction="vertical" className="w-100">
                                ...
                                {/* Add button */}
                                <Button className="mt-1" htmlType="submit" type="primary" loading={loading} block >Add Teammate</Button>
                            </AntForm>
                        </Col>
                    </Row>
                </div>
