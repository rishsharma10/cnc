...
//     let apiRes = await henceforthApi.Products.details(_id)
//     return Array.isArray(apiRes?.data) ? apiRes.data[0] : apiRes?.data

// }
// export const getServerSideProps: GetServerSideProps = async (context) => {
//     let cookies = context.req.cookies
//     let cookieLang = cookies[COOKIES_LANGUAGE]
//     let id = cookies[MODULE_PRODUCT_DETAIL]
//     try {
//         const accessToken = parseCookies(context.req.cookies)[COOKIES_USER_ACCESS_TOKEN]
//         if (accessToken) {
//             henceforthApi.setToken(accessToken)
//         }
//         const data = await getDetails(context?.query?._id as string)
//         const langRes = await initLngWithoutAuth(String(id), String(cookieLang))
//         return {
//             props: { data, langProps: langRes },
...
// }
    ...
    // React.useEffect(() => {
    //     setState(data as ProductDetails)
    //     setSelectedImage(data?.images.length ? data?.images[0] : '')
    // }, [router.query._id, language])